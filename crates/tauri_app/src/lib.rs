...
use crate::commands::{generate_graph, get_graphs};
...
pub fn run() -> anyhow::Result<()> {
    let specta_builder = tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![generate_graph, get_graphs])
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![generate_graph, get_graphs])
